...
const nl: typeof en = {
  ...
  forWhom: {
    ...
    items: [
      ...
      { title: "Klaar om outbound op te schalen", desc: "Je hebt het team, de tools en de strategie nodig. Wij worden je verlengstuk." },
    ...
    items: [
      {
        ...
        desc: "We brengen je hele doelmarkt in kaart, leggen je ICP vast en bouwen een geverifieerde prospectlijst met mailadressen en telefoonnummers.",
      ...
      },
      {
        ...
        desc: "We bouwen je outbound-motor vanaf nul: mailinfrastructuur, sequenties, scripts, LinkedIn-flows en routing op basis van signalen.",
      ...
      },
      {
        tag: "Advies",
        title: "Outbound-coaching & audit",
        desc: "Heb je al een salesteam? We doen een audit van je outbound, leggen bloot wat niet werkt en coachen je mensen op bellen, copy en sequencing.",
