...
const en = {
  ...
  hero: {
    ...
    cards: {
      ...
      meetingRotation: [
        "CTO · Siemens Digital — Thu 14:30",
        "Head of Ops · Atlas Copco — Tue 10:00",
        "VP Sales · Bosch Rexroth — Mon 16:15",
        "COO · KUKA Robotics — Wed 11:45",
        "Procurement Lead · ABB — Fri 09:30",
        "CEO · Beckhoff Automation — Thu 13:00",
        "Plant Manager · Festo — Tue 15:30",
      ],
...
const nl: typeof en = {
  ...
  hero: {
    ...
    cards: {
      ...
      meetingRotation: [
        "CTO · Siemens Digital — Do 14:30",
        "Operations Manager · Atlas Copco — Di 10:00",
        "Sales Director · Bosch Rexroth — Ma 16:15",
        "COO · KUKA Robotics — Woe 11:45",
        "Aankoopverantwoordelijke · ABB — Vr 09:30",
        "Zaakvoerder · Beckhoff Automation — Do 13:00",
        "Plant Manager · Festo — Di 15:30",
      ],
