...
const nl: typeof en = {
  ...
  problem: {
    ...
    desc: "Herken je hier iets in? Je bent niet alleen. De meeste technische B2B-bedrijven waar wij mee praten lopen tegen minstens drie van deze dingen aan.",
    items: [
      ...
      { title: "Verkeerde persoon, verkeerde boodschap", desc: "Lukraak mailen waar je domeinreputatie onder lijdt." },
      { title: "Een sales rep aangenomen die niet verkoopt", desc: "Die zit nu vooral admin te doen in plaats van te bellen." },
      { title: "Geen zicht op je pipeline", desc: "Je weet niet wat werkt, wat niet, en wat er nog aan zit te komen." },
    ],
  },
  how: {
    eyebrow: "Onze aanpak",
    ...
    steps: [
      {
        title: "Bouwen",
        desc: "We zetten je prospectlijst vanaf nul op, op basis van jouw ICP. Geverifieerde mailadressen en telefoonnummers, klaar om te bellen of mailen. Bestaande leads krijgen Tier 1.",
      ...
      {
        title: "Boeken",
        desc: "Gekwalificeerde meetings komen rechtstreeks in je agenda. Bij elke afspraak krijg je context en notities mee, zodat je goed voorbereid het gesprek ingaat.",
        tags: ["Gekwalificeerd", "Met context", "In je agenda"],
      },
    ],
  },
  forWhom: {
